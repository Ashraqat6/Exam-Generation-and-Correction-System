...
namespace sql_project
{
    ...
    public partial class ExamSYSEntities : DbContext
    {
        ...
        public virtual int ExamCorrection(Nullable<int> st_Id, Nullable<int> crs_Id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ExamCorrection", st_IdParameter, crs_IdParameter);
        }
